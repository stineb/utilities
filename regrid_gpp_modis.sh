...
do
	...
	# Rscript fillmiss_modis.R

	## get annual total GPP by summing over time dimension (total GPP in 8-day period is given, in kg C m-2)
	sudo cdo yearsum ${iyr}/MODIS-C06__MOD17A2-8-Daily-GPP__0.5deg__${iyr}__NTSG-UMT__UHAM-ICDC__fv0.01_FILLEDBYTIME.nc ${iyr}/MODIS-C06__MOD17A2-8-Daily-GPP__0.5deg__${iyr}__NTSG-UMT__UHAM-ICDC__fv0.01_ann.nc 
